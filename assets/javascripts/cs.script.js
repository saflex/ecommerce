...
if($(window).width() > 768) { 
   $(window).scroll(function () {
    if($(this).scrollTop() > 62){
        $('.top-others').addClass('sticky').fadeIn( 100 );
        $('body').addClass('fixed-menu').fadeIn( 100 );
    } else {
        $('.top-others').removeClass('sticky');
...
jQuery(document).ready(function () {
    jQuery(".fa-shopping-cart, .bgcc").click(function(){
...
function handleCarousel(){
  ...
  if($("#home_collections").length){
      $("#home_collections").owlCarousel({
        ...
        itemsMobile : [360,1],
        //scrollPerPage: true,
        navigationText: ['<i class="fa fa-chevron-left btooltip" ></i>', '<i class="fa fa-chevron-right btooltip" ></i>'],
  ...
  if($("#home_products_3").length){
      $("#home_products_3").owlCarousel({
        navigation : true,
        pagination: false,
        items: 4,
        slideSpeed : 300,
  ...
  if($('#partners').length){
    imagesLoaded('#partners', function() {
      $("#partners").owlCarousel({
        ...
        itemsMobile : [360,1],
        scrollPerPage: true,
        navigationText: ['<i class="fa fa-caret-left btooltip" ></i>', '<i class="fa fa-caret-right btooltip" ></i>'],
        beforeMove: function(elem) {
          if(touch == false){
